...
activate BONITA
#Template:
#python3 pathway_analysis_score_pathways_mBonita.py Your_omics_data Your_condition_matrix Your_desired_contrasts -sep Separator_used_in_gmt_and_omics_data
