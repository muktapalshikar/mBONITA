...
f3 = colorRamp2(seq(min(temp_binned), max(temp_binned), length = 2), c("white", "navy"))
h1 <- Heatmap(temp_binned,
    ...
    heatmap_legend_param = list(
      ...
      title_position = "topcenter",
      #legend_width = unit(5, 'in'),
      #at = c(0, 2000, 4000, 5000, 10000, 20000),
